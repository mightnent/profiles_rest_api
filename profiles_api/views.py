...
class UserProfileFeedViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = (
        ...
        IsAuthenticated #another layer of check, only authenticated user can even view
    )

    def perform_create(self,serializer):
        """sets user profile to login in user """
        serializer.save(user_profile=self.request.user)
        #only if authenticated will he request have a specific user